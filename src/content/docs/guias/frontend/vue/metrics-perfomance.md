...
const About = () => import('./pages/About.vue') // lazy-load recomendado
...
import { initRUM, instrumentRouter } from './rum'
// import { createPinia } from 'pinia'  // opcional

initRUM({ sampleRate: 0.1, endpoint: '/rum', appVersion: '1.0.0' })
